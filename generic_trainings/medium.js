...
function createArray() {
  ...
  obj.shift = () => {
    ...
    console.log(
      `Deleting value from beginning of object at key: ${shiftedVal}`
    );
    noFuncArr
      .filter((el, i) => {
        return !(i === 0);
...
// holy shit great work. this is a fuck ton, you went wayyyyy above and beyond.
// i think there is a simpler way to do this but feel great about how you did it, you def covered some crazy edge cases
