...
// Nope this is on point, nice job Noley
...
// Perfect- I know you've done this a couple different times buts its a critical concept
...
const cbFilter = function (element) {
  // so we can just return the evaluation statement
...
// I prefer a for loop here, we may find it right away, don't want to continue looping
// but rather break out of the function
...
// only one more note-- STOP FEELING GUILTY. YOU ARE SLAYING IT... in a production code base
// you will always find examples/patterns to copy from, i often mess with coding and then i go
// oh jesus ive done this before and i go look it up in a different file in the codebase
// great work finding examples that help. hard learning to come on projects that aren't already built :-)
