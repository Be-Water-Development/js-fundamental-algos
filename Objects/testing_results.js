...
// To your question-- passing in "plays" does nothing--> blazers and lakers the teams don't take a param
// you pass on it but it goes into the ether
const blazers = () => {
  const plays = {
    firstQuarter: [
