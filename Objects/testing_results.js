...
function gameResult(team1, team2) {
  ...
  function getScore(team) {
    ...
    const allQtr = playsAll.firstQuarter.concat(playsAll.secondQuarter, playsAll.thirdQuarter, playsAll.fourthQuarter);
...
return `${team1name}: ${team1Score}, ${team2name}: ${team2Score}... ${winner(team1Score, team2Score).toUpperCase()} WIN!`
}
